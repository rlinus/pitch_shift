...
verbose=0;
f0_low=120; % take only pitch values above that level
f0_high=400; % below that level
...
for i=1:cs
    ...
    if computed_pitch
        ...
        [f0_time,f0_value,SHR,f0_candidate]=shrp(y,Fs,[50 550],WinSize_ms,StepSize_ms,.4,1250,0,0); % compute pitch
