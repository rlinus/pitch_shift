function make(varargin)
    ...
    elseif strcmpi(varargin{1},'print_device_list')
        mex('../print_device_list.cpp', '-c', '-I../stk-4.5.0/include');
        mex print_device_list.obj Stk.obj RtAudio.obj asio.obj asiolist.obj asiodrivers.obj iasiothiscallresolver.obj
    else
